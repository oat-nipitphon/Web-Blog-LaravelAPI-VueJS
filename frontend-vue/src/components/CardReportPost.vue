<template>
  ...
  >
    ...
    <div class="bg-white border rounded-lg shadow-md m-2 p-2">
      <div class="grid grid-cols-[auto_15%]">
        ...
        <div class="flex justify-end items-end">
          <Menu
            as="div"
            class="relative inline-block text-left mr-5 mt-auto mb-auto"
          >
            <div>
    ...
    <div class="bg-white border rounded-lg shadow-md m-2 p-2">
      ...
      <div class="grid grid-clos-2">
        <div class="flex justify-start">
          <h3
            class="relative z-10 rounded-full px-3 py-1.5 font-medium text-gray-600 mt-auto mb-auto ml -2"
          >
            {{ post?.postTitle }}
          </h3>
        </div>
        <div class="flex justify-end">
          <p class="font-medium text-gray-600 mt-auto mb-auto mr-2 px-3 py-1.5">
      ...
      <div class="grid grid-cols-2">
        <div class="grid grid-cols-2">
          <button
            ...
            type="submit"
            @click="
              onEventPostPop(post?.postID, authStore.users.userProfile.id, 'like')
            "
          >
            <svg
              v-if="
          ...
          <p class="m-auto p-2 text-2xl font-blod">
        ...
        <div class="grid grid-cols-2">
          ...
          <p class="m-auto p-2 text-2xl font-blod">
            {{
              post?.postPops.filter((pop) => pop.popStatus === "disLike").length
            }}
          </p>
        </div>
      </div>
    ...
    <CardEventPop
      :on-event-post-pop="storeEventPostPop"
      :post-id="post?.postID"
      :auth-profile-id="authStore.users?.userProfile?.profileID"
      :post-pop="post?.postPop"
    />
  </article>
</template>
